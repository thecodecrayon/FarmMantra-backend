...
import { Artisan, Category, Product, View } from "../../models/index.js";
import { asyncHandler } from "../../utils/index.js";
import { sequelize } from "../../db/connectDB.js";

export const getViewsByProduct = asyncHandler(async (req, res) => {
...
export const addViewsByProduct = asyncHandler(async (req, res) => {
  const { productId } = req.params;
...
export const getOverallViews = asyncHandler(async (req, res) => {
